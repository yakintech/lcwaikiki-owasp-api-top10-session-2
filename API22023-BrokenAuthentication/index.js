...
const users = [
    ...
    },
    {
        id: 2,
        username: "ece",
        passwordHash: bcrypt.hashSync("password2", 8)
    }
]
...
// Bu uygulamada üvenlik açısından aşağıdaki işlemler yapıldı
// Parola hashleme: bcrypt kütüphanesi kullanıldı
//JWT kullanımı: Token oluşturuldu ve bu token ile yetkilendirme yapıldı
